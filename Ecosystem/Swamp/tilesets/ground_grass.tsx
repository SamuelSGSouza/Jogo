...
<tileset version="1.10" tiledversion="1.11.2" name="ground_grass" tilewidth="16" tileheight="16" tilecount="270" columns="9">
 <image source="../graphics/tilesets/ground_grass.png" width="144" height="480"/>
 <wangsets>
  <wangset name="Nova terra" type="corner" tile="-1">
   <wangcolor name="Terreno" color="#ff0000" tile="-1" probability="1"/>
   ...
   <wangtile tileid="40" wangid="0,0,0,0,0,1,0,1"/>
   ...
   <wangtile tileid="48" wangid="0,1,0,1,0,1,0,0"/>
  ...
  <wangset name="Chão fixo terreno" type="corner" tile="-1">
